...
for each player do
   ...
   if current_player.number[1] == 1 and current_player.timer[3].is_zero() then 
      game.show_message_to(current_player, announce_vip, "VIP")
...
do
   ...
   global.number[4] %= 10
   if global.number[4] == 0 and global.number[5] == 0 then
      for each player do
...
for each player do
   ...
   if current_player.number[0] == 1 and current_player.number[4] == 1 then 
      game.play_sound_for(current_player, announce_koth_controlled, true)
      for each player do
   ...
   if current_player.number[0] == 1 and current_player.timer[1].is_zero() then 
      ...
      if current_player.number[4] == 3 and current_player.timer[2].is_zero() then 
         ...
         for each player do
            ...
            game.play_sound_for(current_player, announce_vip_new, true)
            if current_player != global.player[0] then 
               game.show_message_to(current_player, none, "King %s has chosen a throne", global.player[0])
            end
            if current_player == global.player[0] then 
               game.show_message_to(current_player, none, "You have chosen a throne")
            end
            current_player.timer[3] = 5
